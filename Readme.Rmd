...
==============
Attention: Due to the downtime of the community-server of biomaRt, caRpools 0.82.5 does not function properly.
A hotfix package 0.83 is released soon that uses by default the Ensembl servers for data annotation.
==============
