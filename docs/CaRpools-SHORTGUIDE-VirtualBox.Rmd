...
* Now download the official caRpools virtual appliance from [here](http://www.dkfz.de/signaling/caRpools/caRpools-64bit-Appliance.zip) (1.6 GB)  
...
* after the virtual machine has loaded login the system using username: crispr, password: crispr. 
