...
5. copy the folder to wehre you want to do the analysis.
if this is not your R working directory, you need to pass the working directory to caRpools by either startign it with use.caRpools() or set it manually before using setwd("YOUR WORKING DIR").
