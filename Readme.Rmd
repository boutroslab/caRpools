...
# Our new tool is soon available!

![CRISPRAnalyzeR](https://github.com/boutroslab/crispr-analyzer/blob/master/images/CRISPRAnalyzR_logo5.png)

**Platform-independent, fully-interactive and exploratory screening analysis including comprehensive documentation**

Visit the **[Github](https://github.com/boutroslab/crispr-analyzer) page**
